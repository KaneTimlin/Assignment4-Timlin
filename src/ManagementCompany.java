...
public class ManagementCompany {
    ...
    private int maxRentPropertyIndex() {
        ...
        for (int i = 1; i < MAX_PROPERTY; i++) {
            ...
            if (properties[i].getRent() > properties[indexMaxRent].getRent())
                indexMaxRent = i;
        }
        return indexMaxRent;
    }
    ...
    /**
     * Uses maxRentPropertyIndex to find the index of the highest rent, and returns that rent value
     * @return the value of the highest rent property
     */
    public double maxRentProp() {
        return properties[maxRentPropertyIndex()].getRent();
    }

    /**
     *
     * @param i the index of the property to be printed
     * @return the toString value of the property
     */
    ...
    /**
     *
     * @return the string representation of the Management property
     */
